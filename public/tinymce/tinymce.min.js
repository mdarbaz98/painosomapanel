!(function () {
    ...
    var Ne,
        ...
        vt = {
            ...
            os: { current: dt.current, version: dt.version, isAndroid: dt.isAndroid, isChromeOS: dt.isChromeOS, isFreeBSD: dt.isFreeBSD, isiOS: dt.isiOS, isLinux: dt.isLinux, isOSX: dt.isOSX, isSolaris: dt.isSolaris, isWindows: dt.isWindows },
    ...
    var qr,
        ...
        Co = function (e) {
            return e && e.hasAttribute("data-mce-caret")
                ? ((t = e.getElementsByTagName("br")), (n = t[t.length - 1]), Rn(n) && n.parentNode.removeChild(n), e.removeAttribute("data-mce-caret"), e.removeAttribute("data-mce-bogus"), e.removeAttribute("style"), e.removeAttribute("_moz_abspos"), e)
                : null;
            var t, n;
        },
        wo = Fn,
        ...
        (Ai = Na.tokenize =
            function (e, t) {
                ...
                for (a = e, u = [], s = _i.preFilter; a; ) {
                    for (i in ((n && !(r = la.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))), (n = !1), (r = fa.exec(a)) && ((n = r.shift()), o.push({ value: n, type: r[0].replace(ca, " ") }), (a = a.slice(n.length))), _i.filter))
    ...
    (eu.fn = eu.prototype =
        {
            ...
            offset: function (e) {
                ...
                return e
                    ? this.css(e)
                    : ((t = this[0]) && ((r = (n = t.ownerDocument).documentElement), t.getBoundingClientRect && ((i = (o = t.getBoundingClientRect()).left + (r.scrollLeft || n.body.scrollLeft) - r.clientLeft), (a = o.top + (r.scrollTop || n.body.scrollTop) - r.clientTop))), { left: i, top: a });
            },
            push: Ma,
    ...
    var bu = yu,
        ...
        Su =
            ...
            (Nu.prototype.add = function (e, t, n, r) {
                this.states[e] === undefined && (this.queue.push(e), (this.states[e] = 0)), t && (this.scriptLoadedCallbacks[e] || (this.scriptLoadedCallbacks[e] = []), this.scriptLoadedCallbacks[e].push({ success: t, failure: r, scope: n || this }));
            }),
    ...
    var ll,
        ...
        Cl = function (e, t, n) {
            ...
            if (dl(l)) {
                ...
                if (0 < e && f < l.childNodes.length && ((o = yl(l, f)), gl(o)))
                    return pl(o) ? ((u = n), (c = (s = o).nextSibling) && gl(c) ? (dl(c) ? Us(c, 0) : Us.before(c)) : Cl(Ms.Forwards, Us.after(s), u)) : !hl(o) && (i = Gc(o, e, vl, o)) ? (dl(i) ? Us(i, 0) : Us.before(i)) : dl(o) ? Us(o, 0) : Us.after(o);
                r = o || a.getNode();
            }
        ...
        Gl = function (e, t, n) {
            ...
            if ((n.startContainer !== n.endContainer || !(a = n.startContainer.childNodes[n.startOffset]) || !/^(IMG)$/.test(a.nodeName)) && 1 === s.nodeType)
                for (u < (i = s.childNodes).length ? ((s = i[u]), (r = new Hr(s, e.getParent(s, e.isBlock)))) : ((s = i[i.length - 1]), (r = new Hr(s, e.getParent(s, e.isBlock))).next(!0)), o = r.current(); o; o = r.next()) if (3 === o.nodeType && !ef(o)) return n.setStart(o, 0), void t.setRng(n);
        },
        Jl = function (e, t, n) {
            if (e) {
            ...
            return U.some(e)
                ...
                .bind(function (e) {
                    var t,
                        ...
                        s,
                        c = e.container();
                    return ((i = l), (u = (a = c).data), (s = Is(a, 0)), !(!Dp(u, 0) || Ap(i, s) || ((a.data = " " + u.slice(1)), 0)) || Bp(c) || ((t = l), (r = (n = c).data), (o = Is(n, r.length - 1)), !(!Dp(r, r.length - 1) || Ap(t, o) || ((n.data = r.slice(0, -1) + " "), 0))))
                        ? U.some(e)
                        : U.none();
                });
        },
            ...
            0 !== n &&
                ...
                e.replaceData(
                    ...
                    W(
                        (s = i),
                        function (e, t) {
                            return Kl(t) || Wl(t) ? (e.previousCharIsSpace || ("" === e.str && c) || (e.str.length === s.length - 1 && l) ? { previousCharIsSpace: !1, str: e.str + oo } : { previousCharIsSpace: !0, str: e.str + " " }) : { previousCharIsSpace: !1, str: e.str + t };
                        },
                        ...
                        : ((t = u),
                          ...
                          0 === (r = s).length || /^\s+$/.test(r)
                              ? ((a = '<br data-mce-bogus="1">'),
                                ...
                                zg(t, r),
                                t.fire("SetContent", o))
                              : ("raw" !== o.format && (r = Tm({ validate: t.validate }, t.schema).serialize(t.parser.parse(r, { isRootContent: !0, insert: !0 }))), (o.content = no(Nt.fromDom(n)) ? r : xt.trim(r)), zg(t, o.content), o.no_events || t.fire("SetContent", o)),
                          o.content);
                    var t, n, r, o, i, a;
                })
            );
                ...
                v = {
                    ...
                    getNode: function () {
                        return (function (e, t) {
                            ...
                            return !t.collapsed && (n === r && i - o < 2 && n.hasChildNodes() && (a = n.childNodes[o]), 3 === n.nodeType && 3 === r.nodeType && ((n = n.length === o ? Cm(n.nextSibling, !0) : n.parentNode), (r = 0 === i ? Cm(r.previousSibling, !1) : r.parentNode), n && n === r))
                                ? n
                                : a && 3 === a.nodeType
                                ? a.parentNode
                                : a;
    ...
    var Yy = 0,
        ...
        Jy = function (s) {
            var n,
                ...
                b = function (n) {
                    return (
                        (r = r || Xy(f, { url: s.getParam("images_upload_url", "", "string"), basePath: s.getParam("images_upload_base_path", "", "string"), credentials: s.getParam("images_upload_credentials", !1, "boolean"), handler: s.getParam("images_upload_handler", null, "function") })),
                        x().then(
                            m(function (u) {
                                            ...
                                            t = F(e, function (e, t) {
                                                ...
                                                return (
                                                    e.status && s.getParam("images_replace_blob_uris", !0, "boolean")
                                                        ...
                                                        : e.error && (e.error.options.remove && (h(i.getAttribute("src"), vt.transparentSrc), a.push(i)), (n = s), (r = e.error.message), Hy(n, Au.translate(["Failed to upload image: {0}", r]))),
            ...
            var e,
                ...
                l = function (e, t) {
                    ...
                    !(function (e) {
                        ...
                        (("" !== u.getAttrib(n, mb)) === r && !t) || (u.setAttrib(n, mb, r ? c : null), u.setAttrib(n, "aria-placeholder", r ? c : null), (i = r), a.fire("PlaceholderToggle", { state: i }), a.on(r ? "keydown" : "keyup", l), a.off(r ? "keyup" : "keydown", l)));
                };
            c &&
        ...
        Hx = function (e, t, n, r, o) {
            ...
            n !== e.getBody() &&
                ...
                jx(n, r, !0) && jx(n, r, !1)
                    ...
                    : jx(n, r, !1)
                    ? f.insertAfter(a, zx(n))
                    : ((n = zx(n)), (u = d.cloneRange()).setStartAfter(r), u.setEndAfter(n), (s = u.extractContents()), "LI" === o && ((l = "LI"), (c = s).firstChild && c.firstChild.nodeName === l) ? ((a = s.firstChild), f.insertAfter(s, n)) : (f.insertAfter(s, n), f.insertAfter(a, n))),
                f.remove(r),
                Ix(e, a));
        },
        Vx = function (e) {
    ...
    var BS = function (e) {
                    ...
                    u.on("drop", function (e) {
                        ...
                        h(e) ||
                            ((t = (i = e).dataTransfer && (a = i.dataTransfer.getData(p)) && 0 <= a.indexOf(m) ? ((a = a.substr(m.length).split(",")), { id: unescape(a[0]), html: unescape(a[1]) }) : null) &&
                                t.id !== u.id &&
                                (e.preventDefault(), (n = ed(e.x, e.y, u.getDoc())), d.setRng(n), (r = t.html), (o = !0), u.queryCommandSupported("mceInsertClipboardContent") ? u.execCommand("mceInsertClipboardContent", !1, { content: r, internal: o }) : u.execCommand("mceInsertContent", !1, r)));
                    })),
                t &&
                    (u.on("keydown", function (e) {
                        if (!h(e) && e.keyCode === c) {
        ...
        pN = function (e) {
            ...
            return (
                ...
                e.inline ? oN(e) : ((p = uN((d = e), (m = g))), m.editorContainer && ((iN.get(m.editorContainer).style.display = d.orgDisplay), (d.hidden = iN.isHidden(m.editorContainer))), (d.getElement().style.display = "none"), iN.setAttrib(d.id, "aria-hidden", "true"), void (p || oN(d)))
            );
        },
        gN = bu.DOM,
        hN = function (e) {
                    ...
                    "Cut,Copy,Paste": function (e) {
                        ...
                        "paste" !== e || r.queryCommandEnabled(e) || (t = !0),
                            (!t && r.queryCommandSupported(e)) ||
                                ((n = i.translate("Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.")), vt.mac && (n = n.replace(/Ctrl\+/g, "\u2318+")), i.notificationManager.open({ text: n, type: "error" }));
                    },
                    unlink: function () {
                        var e;
                    ...
                    return (
                        ...
                        (n.toHsv = function () {
                            return (
                                ...
                                (a = tk(e, tk(t, n))),
                                i === a ? { h: 0, s: 0, v: 100 * (o = i) } : ((r = (a - i) / a), { h: nk(60 * ((e === i ? 3 : n === i ? 1 : 5) - (e === i ? t - n : n === i ? e - t : n - e) / ((o = a) - i))), s: nk(100 * r), v: nk(100 * o) })
                            );
                            var e, t, n, r, o, i, a;
                        }),
                        (n.toHex = function () {
